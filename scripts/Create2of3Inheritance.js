...
const { owner, inheritor, inheritorTwo, inheritorThree } = require('./wallets.json');
...
const witnessScript = cltvCheckSigOutput(keyPairOwner, keyPairInheritor, keyPairInheritorTwo, keyPairInheritorThree, lockTime);
...
function cltvCheckSigOutput(owner, inheritor, inheritorTwo, inheritorThree, lockTime) {
    return bitcoin.script.fromASM(
        ...
        OP_ELSE
            ...
            ${inheritorTwo.publicKey.toString('hex')}
            ${inheritorThree.publicKey.toString('hex')}
            OP_3
            OP_CHECKMULTISIG
        OP_ENDIF
      `
